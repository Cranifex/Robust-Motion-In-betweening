...
dfki_offsets = [
    ...
    [0.000000, 9.835631, -1.092848],
    [0.000000, 10.591047, 0.000000],
    [0.000000, 9.678778, -0.061326],
    [0.000000, 9.667962, -0.061388],
    [0.000000, 13.193331, 0.000000],
    [0.000000, 10.073112, 0.047457],
    [0.000000, 19.407518, -0.004973],

    [-2.843240 ,7.432117 ,0.000000],
    [-14.519779, 0.000000, 0.000000],
    [-31.049371, 0.000000, 0.000000],
    [-27.592528, 0.000000, 0.004495],
    [-20.034348, 0.000000, 0.000000],
    ...
    [-8.333579, 0.151391, -0.016821],
    [0.000000, -51.539558, 0.003854],
    [0.000000, -46.963166, -0.038588],
    [0.000000, -7.076615, 17.983790],
    [0.000000, -3.010046, 9.327578],

    [8.333579, 0.148821, -0.016536],
    [0.000000, -51.539558 ,0.003854],
    [0.000000, -46.963166, -0.038588],
    [0.000000, -7.076615, 17.983790],
    [0.000000, -3.010046, 9.327578]
...
dfki_offsets = [
    ...
    [ 0.000000, 1.092846 ,9.835631],
    [0.000000, -0.000002, 10.591046],
    [0.000000, 0.061324, 9.678778],
    [0.000000, 0.061386, 9.667963],
    [0.000000, -0.000002, 13.193333],
    [ 0.000000, -0.047459, 10.073112],
    [0.000000, 0.004970, 19.407516],

    [-2.843240, -0.000001, 7.432117],
    [-14.519780, 0.000000, 0.000000],
    [-31.049372, 0.000000, 0.000000],
    [-27.592529, -0.004495, 0.000000],
    [-20.034348, 0.000000, 0.000000],
    ...
    [-8.333579, 0.016821, 0.151391],
    [0.000000, -0.003846, -51.539558],
    [0.000000, 0.038596, -46.963165],
    [0.000000, -17.983788, -7.076614],
    [0.000000, -9.327578, -3.010056],

    [8.333579, 0.016536 ,0.148821],
    [0.000000, -0.003846, -51.539558],
    [0.000000, 0.038596, -46.963161],
    [0.000000, -17.983789, -7.076614],
    [0.000000, -9.327578, -3.010056]
]
sk_offsets = [
...
dfki_parents = [ -1, 0, 1, 2, 3, 4, 5, 6,
                4, 8, 9, 10, 11,
                4, 13, 14, 15, 16,
                0, 18, 19, 20, 21,
                0, 23, 24, 25, 26]      
                
sk_parents = [-1,  0,  1,  2,  3,  4,
              0,  6,  7,  8,  9,
              0, 11, 12, 13, 14, 15,
              13, 17, 18, 19, 20, 
              13, 22, 23, 24, 25]
...
dfki_joints_to_remove = [7, 12, 17, 22, 27]

#joint_names = ["Hips", "LeftUpLeg", "LeftLeg", "LeftFoot", "LeftToe", "RightUpLeg", "RightLeg", "RightFoot", "RightToe", 
#               "Spine", "Spine1", "Spine2", "Neck", "Head", "LeftShoulder", "LeftArm", "LeftForeArm", "LeftHand", "RightShoulder", "RightArm", "RightForeArm", "RightHand"]

joint_names = ["Hips", "Chest", "Chest2", "Chest3", "Chest4", "Neck", "Head", "RightCollar", "RightShoulder", "RightElbow", "RightWrist",
                     "LeftCollar", "LeftElbow", "LeftWrist", "RightHip", "RightKnee", "RightAnkle", "RightToe", "LeftHip", "LeftKnee", "LeftAnkle", "LeftToe"]
